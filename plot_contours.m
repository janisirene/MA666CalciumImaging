function [CC,jsf] = plot_contours(Aor,Cn,options,display_numbers,max_number,Coor, ln_wd, lbl)
...
% ln_wd:            linewidth (optional, default=1)
% lbl:              cell numbers (optional, default=(1:K)
